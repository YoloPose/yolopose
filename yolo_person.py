...
class YOLO_TF:
    ...
    def __init__(self, imshow=False, disp_console=True):
        self.imshow = imshow
        self.disp_console = disp_console
        self.build_networks()
    ...
    def detect_from_cvmat(self, img):
        ...
        if self.imshow: self.show_results(img, self.result)
...
if __name__ == '__main__':
    yolo = YOLO_TF()
    img = cv2.imread('./data/images/000040154.jpg')
    r = yolo.detect_from_cvmat(img)
